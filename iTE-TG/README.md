> **2026-09-23 项目整理说明**：本目录整体属于旧阶段工作区，当前研究入口见 [项目根目录 README](../README.md)。下面标为“当前”“最终”“优先”的内容均为当时的历史状态，不能作为现行流程或已验收结果。原始表和溯源记录仍保留原位置。53 个 TIFF 已无损压缩归档，PNG/PDF/SVG 保留，恢复方法见 [整理记录](../archive/cleanup_20260923/README.md)。

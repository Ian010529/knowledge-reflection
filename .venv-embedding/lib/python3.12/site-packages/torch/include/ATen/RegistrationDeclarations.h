...
at::Tensor _cdist_backward(const at::Tensor & grad_output, const at::Tensor & x1, const at::Tensor & x2, double p, const at::Tensor & cdist); // {"schema": "aten::_cdist_backward(Tensor grad_output, Tensor x1, Tensor x2, float p, Tensor cdist) -> Tensor", "dispatch": "True", "default": "False"}
...
at::Tensor _pdist_backward(const at::Tensor & grad_output, const at::Tensor & self, double p, const at::Tensor & pdist); // {"schema": "aten::_pdist_backward(Tensor grad_output, Tensor self, float p, Tensor pdist) -> Tensor", "dispatch": "True", "default": "False"}
...
at::Tensor _philox_key_fold_in(const at::Tensor & key, const at::Tensor & data); // {"schema": "aten::_philox_key_fold_in.Tensor(Tensor key, Tensor data) -> Tensor", "dispatch": "True", "default": "False"}
...
at::Tensor _scaled_mm_v2(const at::Tensor & self, const at::Tensor & mat2, const at::ITensorListRef & scale_a, at::IntArrayRef recipe_a, at::IntArrayRef swizzle_a, const at::ITensorListRef & scale_b, at::IntArrayRef recipe_b, at::IntArrayRef swizzle_b, const ::std::optional<at::Tensor> & bias, ::std::optional<at::ScalarType> out_dtype, at::IntArrayRef contraction_dim, bool use_fast_accum); // {"schema": "aten::_scaled_mm_v2(Tensor self, Tensor mat2, Tensor[] scale_a, int[] recipe_a, int[] swizzle_a, Tensor[] scale_b, int[] recipe_b, int[] swizzle_b, Tensor? bias, ScalarType? out_dtype, int[] contraction_dim=[], bool use_fast_accum=False) -> Tensor", "dispatch": "True", "default": "True"}
at::Tensor & _scaled_mm_v2_out(const at::Tensor & self, const at::Tensor & mat2, const at::ITensorListRef & scale_a, at::IntArrayRef recipe_a, at::IntArrayRef swizzle_a, const at::ITensorListRef & scale_b, at::IntArrayRef recipe_b, at::IntArrayRef swizzle_b, const ::std::optional<at::Tensor> & bias, ::std::optional<at::ScalarType> out_dtype, at::IntArrayRef contraction_dim, bool use_fast_accum, at::Tensor & out); // {"schema": "aten::_scaled_mm_v2.out(Tensor self, Tensor mat2, Tensor[] scale_a, int[] recipe_a, int[] swizzle_a, Tensor[] scale_b, int[] recipe_b, int[] swizzle_b, Tensor? bias, ScalarType? out_dtype, int[] contraction_dim=[], bool use_fast_accum=False, *, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
...
at::Tensor _scaled_grouped_mm_v2(const at::Tensor & self, const at::Tensor & mat2, const at::ITensorListRef & scale_a, at::IntArrayRef recipe_a, at::IntArrayRef swizzle_a, const at::ITensorListRef & scale_b, at::IntArrayRef recipe_b, at::IntArrayRef swizzle_b, const ::std::optional<at::Tensor> & offs, const ::std::optional<at::Tensor> & bias, ::std::optional<at::ScalarType> out_dtype, at::IntArrayRef contraction_dim, bool use_fast_accum); // {"schema": "aten::_scaled_grouped_mm_v2(Tensor self, Tensor mat2, Tensor[] scale_a, int[] recipe_a, int[] swizzle_a, Tensor[] scale_b, int[] recipe_b, int[] swizzle_b, Tensor? offs=None, Tensor? bias=None, ScalarType? out_dtype=None, int[] contraction_dim=[], bool use_fast_accum=False) -> Tensor", "dispatch": "True", "default": "True"}
at::Tensor & _scaled_grouped_mm_v2_out(const at::Tensor & self, const at::Tensor & mat2, const at::ITensorListRef & scale_a, at::IntArrayRef recipe_a, at::IntArrayRef swizzle_a, const at::ITensorListRef & scale_b, at::IntArrayRef recipe_b, at::IntArrayRef swizzle_b, const ::std::optional<at::Tensor> & offs, const ::std::optional<at::Tensor> & bias, ::std::optional<at::ScalarType> out_dtype, at::IntArrayRef contraction_dim, bool use_fast_accum, at::Tensor & out); // {"schema": "aten::_scaled_grouped_mm_v2.out(Tensor self, Tensor mat2, Tensor[] scale_a, int[] recipe_a, int[] swizzle_a, Tensor[] scale_b, int[] recipe_b, int[] swizzle_b, Tensor? offs=None, Tensor? bias=None, ScalarType? out_dtype=None, int[] contraction_dim=[], bool use_fast_accum=False, *, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
...
at::Tensor linalg_matrix_sqrth(const at::Tensor & self); // {"schema": "aten::linalg_matrix_sqrth(Tensor self) -> Tensor", "dispatch": "True", "default": "False"}
...
::std::tuple<at::Tensor,at::Tensor> linalg_polar(const at::Tensor & A); // {"schema": "aten::linalg_polar(Tensor A) -> (Tensor U, Tensor H)", "dispatch": "True", "default": "True"}
::std::tuple<at::Tensor &,at::Tensor &> linalg_polar_out(const at::Tensor & A, at::Tensor & U, at::Tensor & H); // {"schema": "aten::linalg_polar.out(Tensor A, *, Tensor(a!) U, Tensor(b!) H) -> (Tensor(a!) U, Tensor(b!) H)", "dispatch": "True", "default": "False"}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,c10::SymInt,c10::SymInt,at::Tensor,at::Tensor,at::Tensor> _cudnn_attention_forward(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & attn_bias, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, bool compute_log_sumexp, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & block_table); // {"schema": "aten::_cudnn_attention_forward(Tensor query, Tensor key, Tensor value, Tensor? attn_bias, Tensor? cum_seq_q, Tensor? cum_seq_k, SymInt max_q, SymInt max_k, bool compute_log_sumexp, float dropout_p=0.0, bool is_causal=False, bool return_debug_mask=False, *, float? scale=None, Tensor? seqused_k=None, Tensor? block_table=None) -> (Tensor output, Tensor logsumexp, Tensor cum_seq_q, Tensor cum_seq_k, SymInt max_q, SymInt max_k, Tensor philox_seed, Tensor philox_offset, Tensor debug_attn_mask)", "dispatch": "True", "default": "False"}
...
at::Tensor & _cdist_backward_out(const at::Tensor & grad_output, const at::Tensor & x1, const at::Tensor & x2, double p, const at::Tensor & cdist, at::Tensor & out); // {"schema": "aten::_cdist_backward.out(Tensor grad_output, Tensor x1, Tensor x2, float p, Tensor cdist, *, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "True"}
...
at::Tensor & _pdist_backward_out(const at::Tensor & grad_output, const at::Tensor & self, double p, const at::Tensor & pdist, at::Tensor & out); // {"schema": "aten::_pdist_backward.out(Tensor grad_output, Tensor self, float p, Tensor pdist, *, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "True"}
...
at::Tensor & linalg_matrix_sqrth_out(const at::Tensor & self, at::Tensor & out); // {"schema": "aten::linalg_matrix_sqrth.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "True"}
